...
bool node_interface__msg__robot_hurt__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("node_interface.msg._robot_hurt.RobotHurt", full_classname_dest, 40) == 0);
  }
  node_interface__msg__RobotHurt * ros_message = _ros_message;
  {  // armor_id
...
PyObject * node_interface__msg__robot_hurt__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("node_interface.msg._robot_hurt");
