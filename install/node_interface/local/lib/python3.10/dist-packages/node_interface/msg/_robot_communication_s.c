...
bool node_interface__msg__robot_communication__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("node_interface.msg._robot_communication.RobotCommunication", full_classname_dest, 58) == 0);
  }
  node_interface__msg__RobotCommunication * ros_message = _ros_message;
  {  // data_cmd_id
...
PyObject * node_interface__msg__robot_communication__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("node_interface.msg._robot_communication");
