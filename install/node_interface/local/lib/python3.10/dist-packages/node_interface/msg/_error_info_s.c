...
bool node_interface__msg__error_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("node_interface.msg._error_info.ErrorInfo", full_classname_dest, 40) == 0);
  }
  node_interface__msg__ErrorInfo * ros_message = _ros_message;
  {  // code
...
PyObject * node_interface__msg__error_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("node_interface.msg._error_info");
