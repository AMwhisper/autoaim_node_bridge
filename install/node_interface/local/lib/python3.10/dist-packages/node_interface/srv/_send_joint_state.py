...
class Metaclass_SendJointState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'node_interface.srv.SendJointState')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from node_interface.srv import _send_joint_state
...
class SendJointState(metaclass=Metaclass_SendJointState):
    from node_interface.srv._send_joint_state import SendJointState_Request as Request
    from node_interface.srv._send_joint_state import SendJointState_Response as Response
