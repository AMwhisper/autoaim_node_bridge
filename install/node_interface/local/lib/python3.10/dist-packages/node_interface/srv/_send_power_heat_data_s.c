...
bool node_interface__srv__send_power_heat_data__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("node_interface.srv._send_power_heat_data.SendPowerHeatData_Request", full_classname_dest, 66) == 0);
  }
  node_interface__srv__SendPowerHeatData_Request * ros_message = _ros_message;
  {  // chassis_volt
    ...
    ros_message->chassis_volt = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // chassis_current
    ...
    assert(PyLong_Check(field));
    ros_message->chassis_current = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // chassis_power
...
{
  /* NOTE(esteve): Call constructor of SendPowerHeatData_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("node_interface.srv._send_power_heat_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SendPowerHeatData_Request");
  ...
  {  // chassis_volt
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->chassis_volt);
    {
  ...
  {  // chassis_current
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->chassis_current);
    {
...
ROSIDL_GENERATOR_C_EXPORT
bool node_interface__srv__send_power_heat_data__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("node_interface.srv._send_power_heat_data.SendPowerHeatData_Response", full_classname_dest, 67) == 0);
  }
  node_interface__srv__SendPowerHeatData_Response * ros_message = _ros_message;
  {  // result
...
{
  /* NOTE(esteve): Call constructor of SendPowerHeatData_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("node_interface.srv._send_power_heat_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SendPowerHeatData_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
