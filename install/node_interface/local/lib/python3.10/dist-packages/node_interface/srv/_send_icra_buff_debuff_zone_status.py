...
class Metaclass_SendIcraBuffDebuffZoneStatus_Request(type):
    """Metaclass of message 'SendIcraBuffDebuffZoneStatus_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'node_interface.srv.SendIcraBuffDebuffZoneStatus_Request')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__send_icra_buff_debuff_zone_status__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__send_icra_buff_debuff_zone_status__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__send_icra_buff_debuff_zone_status__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__send_icra_buff_debuff_zone_status__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__send_icra_buff_debuff_zone_status__request
...
class SendIcraBuffDebuffZoneStatus_Request(metaclass=Metaclass_SendIcraBuffDebuffZoneStatus_Request):
    """Message class 'SendIcraBuffDebuffZoneStatus_Request'."""
...
class Metaclass_SendIcraBuffDebuffZoneStatus_Response(type):
    """Metaclass of message 'SendIcraBuffDebuffZoneStatus_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'node_interface.srv.SendIcraBuffDebuffZoneStatus_Response')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__send_icra_buff_debuff_zone_status__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__send_icra_buff_debuff_zone_status__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__send_icra_buff_debuff_zone_status__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__send_icra_buff_debuff_zone_status__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__send_icra_buff_debuff_zone_status__response
...
class SendIcraBuffDebuffZoneStatus_Response(metaclass=Metaclass_SendIcraBuffDebuffZoneStatus_Response):
    """Message class 'SendIcraBuffDebuffZoneStatus_Response'."""
...
class Metaclass_SendIcraBuffDebuffZoneStatus(type):
    """Metaclass of service 'SendIcraBuffDebuffZoneStatus'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'node_interface.srv.SendIcraBuffDebuffZoneStatus')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__send_icra_buff_debuff_zone_status

            from node_interface.srv import _send_icra_buff_debuff_zone_status
            if _send_icra_buff_debuff_zone_status.Metaclass_SendIcraBuffDebuffZoneStatus_Request._TYPE_SUPPORT is None:
                _send_icra_buff_debuff_zone_status.Metaclass_SendIcraBuffDebuffZoneStatus_Request.__import_type_support__()
            if _send_icra_buff_debuff_zone_status.Metaclass_SendIcraBuffDebuffZoneStatus_Response._TYPE_SUPPORT is None:
                _send_icra_buff_debuff_zone_status.Metaclass_SendIcraBuffDebuffZoneStatus_Response.__import_type_support__()


class SendIcraBuffDebuffZoneStatus(metaclass=Metaclass_SendIcraBuffDebuffZoneStatus):
    from node_interface.srv._send_icra_buff_debuff_zone_status import SendIcraBuffDebuffZoneStatus_Request as Request
    from node_interface.srv._send_icra_buff_debuff_zone_status import SendIcraBuffDebuffZoneStatus_Response as Response
