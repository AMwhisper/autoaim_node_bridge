...
node_interface__msg__ClientCustomGraphicSeven__init(node_interface__msg__ClientCustomGraphicSeven * msg)
{
  ...
  for (size_t i = 0; i < 7; ++i) {
    if (!node_interface__msg__GraphicDataType__init(&msg->grapic_data_struct[i])) {
      node_interface__msg__ClientCustomGraphicSeven__fini(msg);
      return false;
    }
  }
  return true;
...
node_interface__msg__ClientCustomGraphicSeven__create()
{
  ...
  node_interface__msg__ClientCustomGraphicSeven * msg = (node_interface__msg__ClientCustomGraphicSeven *)allocator.allocate(sizeof(node_interface__msg__ClientCustomGraphicSeven), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(node_interface__msg__ClientCustomGraphicSeven));
  bool success = node_interface__msg__ClientCustomGraphicSeven__init(msg);
  if (!success) {
...
node_interface__msg__ClientCustomGraphicSeven__Sequence__init(node_interface__msg__ClientCustomGraphicSeven__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  node_interface__msg__ClientCustomGraphicSeven * data = NULL;

  if (size) {
    data = (node_interface__msg__ClientCustomGraphicSeven *)allocator.zero_allocate(size, sizeof(node_interface__msg__ClientCustomGraphicSeven), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = node_interface__msg__ClientCustomGraphicSeven__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        node_interface__msg__ClientCustomGraphicSeven__fini(&data[i - 1]);
      }
...
node_interface__msg__ClientCustomGraphicSeven__Sequence__fini(node_interface__msg__ClientCustomGraphicSeven__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      node_interface__msg__ClientCustomGraphicSeven__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  node_interface__msg__ClientCustomGraphicSeven__Sequence * array = (node_interface__msg__ClientCustomGraphicSeven__Sequence *)allocator.allocate(sizeof(node_interface__msg__ClientCustomGraphicSeven__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = node_interface__msg__ClientCustomGraphicSeven__Sequence__init(array, size);
  if (!success) {
...
node_interface__msg__ClientCustomGraphicSeven__Sequence__destroy(node_interface__msg__ClientCustomGraphicSeven__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    node_interface__msg__ClientCustomGraphicSeven__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
node_interface__msg__ClientCustomGraphicSeven__Sequence__are_equal(const node_interface__msg__ClientCustomGraphicSeven__Sequence * lhs, const node_interface__msg__ClientCustomGraphicSeven__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!node_interface__msg__ClientCustomGraphicSeven__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  node_interface__msg__ClientCustomGraphicSeven__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(node_interface__msg__ClientCustomGraphicSeven);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    node_interface__msg__ClientCustomGraphicSeven * data =
      (node_interface__msg__ClientCustomGraphicSeven *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!node_interface__msg__ClientCustomGraphicSeven__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          node_interface__msg__ClientCustomGraphicSeven__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!node_interface__msg__ClientCustomGraphicSeven__copy(
