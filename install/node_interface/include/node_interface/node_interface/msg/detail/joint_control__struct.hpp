...
#ifndef NODE_INTERFACE__MSG__DETAIL__JOINT_CONTROL__STRUCT_HPP_
#define NODE_INTERFACE__MSG__DETAIL__JOINT_CONTROL__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__node_interface__msg__JointControl __attribute__((deprecated))
#else
# define DEPRECATED__node_interface__msg__JointControl __declspec(deprecated)
#endif
...
struct JointControl_
{
  ...
  // pointer types
  using RawPtr =
    node_interface::msg::JointControl_<ContainerAllocator> *;
  using ConstRawPtr =
    const node_interface::msg::JointControl_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<node_interface::msg::JointControl_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<node_interface::msg::JointControl_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      node_interface::msg::JointControl_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<node_interface::msg::JointControl_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<node_interface::msg::JointControl_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<node_interface::msg::JointControl_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<node_interface::msg::JointControl_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__node_interface__msg__JointControl
    std::shared_ptr<node_interface::msg::JointControl_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__node_interface__msg__JointControl
    std::shared_ptr<node_interface::msg::JointControl_<ContainerAllocator> const>
...
using JointControl =
  node_interface::msg::JointControl_<std::allocator<void>>;
...
#endif  // NODE_INTERFACE__MSG__DETAIL__JOINT_CONTROL__STRUCT_HPP_
