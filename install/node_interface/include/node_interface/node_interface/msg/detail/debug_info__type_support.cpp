...
{
  new (message_memory) node_interface::msg::DebugInfo(_init);
}

void DebugInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<node_interface::msg::DebugInfo *>(message_memory);
  typed_message->~DebugInfo();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember DebugInfo_message_member_array[1] = {
  {
    "debug_data",  // name
    ...
    offsetof(node_interface::msg::DebugInfo, debug_data),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DebugInfo_message_members = {
  ...
  1,  // number of fields
  sizeof(node_interface::msg::DebugInfo),
...
{
  return &::node_interface::msg::rosidl_typesupport_introspection_cpp::DebugInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, node_interface, msg, DebugInfo)() {
  return &::node_interface::msg::rosidl_typesupport_introspection_cpp::DebugInfo_message_type_support_handle;
}
