...
#ifndef NODE_INTERFACE__MSG__DETAIL__CLIENT_CUSTOM_GRAPHIC_FIVE__TRAITS_HPP_
#define NODE_INTERFACE__MSG__DETAIL__CLIENT_CUSTOM_GRAPHIC_FIVE__TRAITS_HPP_
...
inline void to_flow_style_yaml(
  const ClientCustomGraphicFive & msg,
  std::ostream & out)
{
  out << "{";
  // member: data_cmd_id
...
inline std::string to_yaml(const ClientCustomGraphicFive & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const node_interface::msg::ClientCustomGraphicFive & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const node_interface::msg::ClientCustomGraphicFive & msg)
{
  return node_interface::msg::to_yaml(msg);
}

template<>
inline const char * data_type<node_interface::msg::ClientCustomGraphicFive>()
{
  return "node_interface::msg::ClientCustomGraphicFive";
}

template<>
inline const char * name<node_interface::msg::ClientCustomGraphicFive>()
{
  return "node_interface/msg/ClientCustomGraphicFive";
}

template<>
struct has_fixed_size<node_interface::msg::ClientCustomGraphicFive>
  : std::integral_constant<bool, has_fixed_size<node_interface::msg::GraphicDataType>::value> {};

template<>
struct has_bounded_size<node_interface::msg::ClientCustomGraphicFive>
  : std::integral_constant<bool, has_bounded_size<node_interface::msg::GraphicDataType>::value> {};

template<>
struct is_message<node_interface::msg::ClientCustomGraphicFive>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // NODE_INTERFACE__MSG__DETAIL__CLIENT_CUSTOM_GRAPHIC_FIVE__TRAITS_HPP_
