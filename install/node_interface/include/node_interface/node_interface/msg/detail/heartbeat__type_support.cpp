...
{
  new (message_memory) node_interface::msg::Heartbeat(_init);
}

void Heartbeat_fini_function(void * message_memory)
{
  auto typed_message = static_cast<node_interface::msg::Heartbeat *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Heartbeat_message_member_array[1] = {
  {
    ...
    offsetof(node_interface::msg::Heartbeat, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Heartbeat_message_members = {
  ...
  1,  // number of fields
  sizeof(node_interface::msg::Heartbeat),
...
{
  return &::node_interface::msg::rosidl_typesupport_introspection_cpp::Heartbeat_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, node_interface, msg, Heartbeat)() {
  return &::node_interface::msg::rosidl_typesupport_introspection_cpp::Heartbeat_message_type_support_handle;
}
