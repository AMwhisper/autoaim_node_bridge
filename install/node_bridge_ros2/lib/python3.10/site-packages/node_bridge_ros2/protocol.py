...
import re
import os
from node_bridge_ros2 import helpers


# 构建 protocol.yaml 文件的路径
workspace_dir = os.path.expanduser('~/ros/workspace/nbr2_ws')
yaml_path = os.path.join(workspace_dir,'library', 'protocol.yaml')
#yaml_path = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))) + '/library/potocol.yaml'

# 打开并读取 protocol.yaml 文件
