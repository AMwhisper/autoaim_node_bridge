...
#ifndef NODE_INTERFACE__MSG__DETAIL__JOINT_STATE__TRAITS_HPP_
#define NODE_INTERFACE__MSG__DETAIL__JOINT_STATE__TRAITS_HPP_
...
inline void to_yaml(
  const node_interface::msg::JointState & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const node_interface::msg::JointState & msg)
{
  return node_interface::msg::to_yaml(msg);
}

template<>
inline const char * data_type<node_interface::msg::JointState>()
{
  return "node_interface::msg::JointState";
}

template<>
inline const char * name<node_interface::msg::JointState>()
{
  return "node_interface/msg/JointState";
}

template<>
struct has_fixed_size<node_interface::msg::JointState>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<node_interface::msg::JointState>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<node_interface::msg::JointState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // NODE_INTERFACE__MSG__DETAIL__JOINT_STATE__TRAITS_HPP_
