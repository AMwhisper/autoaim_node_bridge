...
#ifndef NODE_INTERFACE__MSG__DETAIL__GAME_ROBOT_STATUS__TRAITS_HPP_
#define NODE_INTERFACE__MSG__DETAIL__GAME_ROBOT_STATUS__TRAITS_HPP_
...
inline void to_yaml(
  const node_interface::msg::GameRobotStatus & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const node_interface::msg::GameRobotStatus & msg)
{
  return node_interface::msg::to_yaml(msg);
}

template<>
inline const char * data_type<node_interface::msg::GameRobotStatus>()
{
  return "node_interface::msg::GameRobotStatus";
}

template<>
inline const char * name<node_interface::msg::GameRobotStatus>()
{
  return "node_interface/msg/GameRobotStatus";
}

template<>
struct has_fixed_size<node_interface::msg::GameRobotStatus>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<node_interface::msg::GameRobotStatus>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<node_interface::msg::GameRobotStatus>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // NODE_INTERFACE__MSG__DETAIL__GAME_ROBOT_STATUS__TRAITS_HPP_
