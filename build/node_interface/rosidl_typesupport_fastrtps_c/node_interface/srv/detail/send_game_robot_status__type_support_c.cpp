...
#include "node_interface/srv/detail/send_game_robot_status__rosidl_typesupport_fastrtps_c.h"
...
using _SendGameRobotStatus_Request__ros_msg_type = node_interface__srv__SendGameRobotStatus_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SendGameRobotStatus_Request__ros_msg_type * ros_message = static_cast<const _SendGameRobotStatus_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: robot_id
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SendGameRobotStatus_Request__ros_msg_type * ros_message = static_cast<_SendGameRobotStatus_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: robot_id
  {
    cdr >> ros_message->robot_id;
  }
...
size_t get_serialized_size_node_interface__srv__SendGameRobotStatus_Request(
  const void * untyped_ros_message,
...
static uint32_t _SendGameRobotStatus_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_node_interface__srv__SendGameRobotStatus_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_node_interface
size_t max_serialized_size_node_interface__srv__SendGameRobotStatus_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = node_interface__srv__SendGameRobotStatus_Request;
    is_plain =
      (
...
static size_t _SendGameRobotStatus_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_node_interface__srv__SendGameRobotStatus_Request(
...
static message_type_support_callbacks_t __callbacks_SendGameRobotStatus_Request = {
  "node_interface::srv",
...
static rosidl_message_type_support_t _SendGameRobotStatus_Request__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SendGameRobotStatus_Request,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_interface, srv, SendGameRobotStatus_Request)() {
  return &_SendGameRobotStatus_Request__type_support;
}
...
using _SendGameRobotStatus_Response__ros_msg_type = node_interface__srv__SendGameRobotStatus_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SendGameRobotStatus_Response__ros_msg_type * ros_message = static_cast<const _SendGameRobotStatus_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: result
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SendGameRobotStatus_Response__ros_msg_type * ros_message = static_cast<_SendGameRobotStatus_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: result
  {
    std::string tmp;
    cdr >> tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_node_interface
size_t get_serialized_size_node_interface__srv__SendGameRobotStatus_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SendGameRobotStatus_Response__ros_msg_type * ros_message = static_cast<const _SendGameRobotStatus_Response__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SendGameRobotStatus_Response__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_node_interface__srv__SendGameRobotStatus_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_node_interface
size_t max_serialized_size_node_interface__srv__SendGameRobotStatus_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = node_interface__srv__SendGameRobotStatus_Response;
    is_plain =
      (
...
static size_t _SendGameRobotStatus_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_node_interface__srv__SendGameRobotStatus_Response(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_SendGameRobotStatus_Response = {
  "node_interface::srv",
...
static rosidl_message_type_support_t _SendGameRobotStatus_Response__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SendGameRobotStatus_Response,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_interface, srv, SendGameRobotStatus_Response)() {
  return &_SendGameRobotStatus_Response__type_support;
}
...
// already included above
// #include "node_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "node_interface/srv/send_game_robot_status.h"
...
static service_type_support_callbacks_t SendGameRobotStatus__callbacks = {
  "node_interface::srv",
  "SendGameRobotStatus",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_interface, srv, SendGameRobotStatus_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_interface, srv, SendGameRobotStatus_Response)(),
...
static rosidl_service_type_support_t SendGameRobotStatus__handle = {
  rosidl_typesupport_fastrtps_c__identifier,
  &SendGameRobotStatus__callbacks,
  get_service_typesupport_handle_function,
};

const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_interface, srv, SendGameRobotStatus)() {
  return &SendGameRobotStatus__handle;
}
