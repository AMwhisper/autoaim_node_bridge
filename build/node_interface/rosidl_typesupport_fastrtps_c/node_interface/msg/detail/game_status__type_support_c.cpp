...
#include "node_interface/msg/detail/game_status__rosidl_typesupport_fastrtps_c.h"
...
using _GameStatus__ros_msg_type = node_interface__msg__GameStatus;
...
size_t get_serialized_size_node_interface__msg__GameStatus(
  const void * untyped_ros_message,
...
static uint32_t _GameStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_node_interface__msg__GameStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_node_interface
size_t max_serialized_size_node_interface__msg__GameStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = node_interface__msg__GameStatus;
    is_plain =
      (
...
static size_t _GameStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_node_interface__msg__GameStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_interface, msg, GameStatus)() {
