...
#include "node_interface/msg/detail/rfid_status__rosidl_typesupport_fastrtps_c.h"
...
using _RfidStatus__ros_msg_type = node_interface__msg__RfidStatus;
...
size_t get_serialized_size_node_interface__msg__RfidStatus(
  const void * untyped_ros_message,
...
static uint32_t _RfidStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_node_interface__msg__RfidStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_node_interface
size_t max_serialized_size_node_interface__msg__RfidStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = node_interface__msg__RfidStatus;
    is_plain =
      (
...
static size_t _RfidStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_node_interface__msg__RfidStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_interface, msg, RfidStatus)() {
