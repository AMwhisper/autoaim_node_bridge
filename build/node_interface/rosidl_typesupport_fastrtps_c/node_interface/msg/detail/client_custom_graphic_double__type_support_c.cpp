...
#include "node_interface/msg/detail/client_custom_graphic_double__rosidl_typesupport_fastrtps_c.h"
...
using _ClientCustomGraphicDouble__ros_msg_type = node_interface__msg__ClientCustomGraphicDouble;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ClientCustomGraphicDouble__ros_msg_type * ros_message = static_cast<const _ClientCustomGraphicDouble__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _ClientCustomGraphicDouble__ros_msg_type * ros_message = static_cast<_ClientCustomGraphicDouble__ros_msg_type *>(untyped_ros_message);
  // Field name: data_cmd_id
  {
    cdr >> ros_message->data_cmd_id;
  }
...
size_t get_serialized_size_node_interface__msg__ClientCustomGraphicDouble(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ClientCustomGraphicDouble__ros_msg_type * ros_message = static_cast<const _ClientCustomGraphicDouble__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ClientCustomGraphicDouble__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_node_interface__msg__ClientCustomGraphicDouble(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_node_interface
size_t max_serialized_size_node_interface__msg__ClientCustomGraphicDouble(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = node_interface__msg__ClientCustomGraphicDouble;
    is_plain =
      (
...
static size_t _ClientCustomGraphicDouble__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_node_interface__msg__ClientCustomGraphicDouble(
...
static message_type_support_callbacks_t __callbacks_ClientCustomGraphicDouble = {
  "node_interface::msg",
...
static rosidl_message_type_support_t _ClientCustomGraphicDouble__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ClientCustomGraphicDouble,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_interface, msg, ClientCustomGraphicDouble)() {
  return &_ClientCustomGraphicDouble__type_support;
}
