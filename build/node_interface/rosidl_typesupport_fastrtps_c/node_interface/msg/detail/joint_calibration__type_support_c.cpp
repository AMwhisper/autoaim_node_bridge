...
#include "node_interface/msg/detail/joint_calibration__rosidl_typesupport_fastrtps_c.h"
...
using _JointCalibration__ros_msg_type = node_interface__msg__JointCalibration;
...
size_t get_serialized_size_node_interface__msg__JointCalibration(
  const void * untyped_ros_message,
...
static uint32_t _JointCalibration__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_node_interface__msg__JointCalibration(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_node_interface
size_t max_serialized_size_node_interface__msg__JointCalibration(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = node_interface__msg__JointCalibration;
    is_plain =
      (
...
static size_t _JointCalibration__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_node_interface__msg__JointCalibration(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_interface, msg, JointCalibration)() {
