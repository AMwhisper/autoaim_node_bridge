...
#include "node_interface/msg/detail/joint_control__rosidl_typesupport_fastrtps_c.h"
...
using _JointControl__ros_msg_type = node_interface__msg__JointControl;
...
size_t get_serialized_size_node_interface__msg__JointControl(
  const void * untyped_ros_message,
...
static uint32_t _JointControl__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_node_interface__msg__JointControl(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_node_interface
size_t max_serialized_size_node_interface__msg__JointControl(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = node_interface__msg__JointControl;
    is_plain =
      (
...
static size_t _JointControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_node_interface__msg__JointControl(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_interface, msg, JointControl)() {
