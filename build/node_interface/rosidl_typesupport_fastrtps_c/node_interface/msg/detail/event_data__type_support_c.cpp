...
#include "node_interface/msg/detail/event_data__rosidl_typesupport_fastrtps_c.h"
...
using _EventData__ros_msg_type = node_interface__msg__EventData;
...
size_t get_serialized_size_node_interface__msg__EventData(
  const void * untyped_ros_message,
...
static uint32_t _EventData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_node_interface__msg__EventData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_node_interface
size_t max_serialized_size_node_interface__msg__EventData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = node_interface__msg__EventData;
    is_plain =
      (
...
static size_t _EventData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_node_interface__msg__EventData(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_interface, msg, EventData)() {
