...
static const _GameRobotPos_type_support_symbol_names_t _GameRobotPos_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, node_interface, msg, GameRobotPos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, node_interface, msg, GameRobotPos)),
  }
};
...
{
  return &::node_interface::msg::rosidl_typesupport_cpp::GameRobotPos_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, node_interface, msg, GameRobotPos)() {
  return get_message_type_support_handle<node_interface::msg::GameRobotPos>();
}
