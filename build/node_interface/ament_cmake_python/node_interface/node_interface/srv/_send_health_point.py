...
class Metaclass_SendHealthPoint_Request(type):
    """Metaclass of message 'SendHealthPoint_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'node_interface.srv.SendHealthPoint_Request')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__send_health_point__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__send_health_point__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__send_health_point__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__send_health_point__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__send_health_point__request
...
class SendHealthPoint_Request(metaclass=Metaclass_SendHealthPoint_Request):
    """Message class 'SendHealthPoint_Request'."""
...
class Metaclass_SendHealthPoint_Response(type):
    """Metaclass of message 'SendHealthPoint_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'node_interface.srv.SendHealthPoint_Response')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__send_health_point__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__send_health_point__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__send_health_point__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__send_health_point__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__send_health_point__response
...
class SendHealthPoint_Response(metaclass=Metaclass_SendHealthPoint_Response):
    """Message class 'SendHealthPoint_Response'."""
...
class Metaclass_SendHealthPoint(type):
    """Metaclass of service 'SendHealthPoint'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'node_interface.srv.SendHealthPoint')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__send_health_point

            from node_interface.srv import _send_health_point
            if _send_health_point.Metaclass_SendHealthPoint_Request._TYPE_SUPPORT is None:
                _send_health_point.Metaclass_SendHealthPoint_Request.__import_type_support__()
            if _send_health_point.Metaclass_SendHealthPoint_Response._TYPE_SUPPORT is None:
                _send_health_point.Metaclass_SendHealthPoint_Response.__import_type_support__()


class SendHealthPoint(metaclass=Metaclass_SendHealthPoint):
    from node_interface.srv._send_health_point import SendHealthPoint_Request as Request
    from node_interface.srv._send_health_point import SendHealthPoint_Response as Response
