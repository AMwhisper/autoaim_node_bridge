...
class Metaclass_SendJointControl_Request(type):
    """Metaclass of message 'SendJointControl_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__send_joint_control__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__send_joint_control__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__send_joint_control__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__send_joint_control__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__send_joint_control__request
...
class SendJointControl_Request(metaclass=Metaclass_SendJointControl_Request):
    """Message class 'SendJointControl_Request'."""
...
class Metaclass_SendJointControl_Response(type):
    """Metaclass of message 'SendJointControl_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__send_joint_control__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__send_joint_control__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__send_joint_control__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__send_joint_control__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__send_joint_control__response
...
class SendJointControl_Response(metaclass=Metaclass_SendJointControl_Response):
    """Message class 'SendJointControl_Response'."""
...
class Metaclass_SendJointControl(type):
    """Metaclass of service 'SendJointControl'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'node_interface.srv.SendJointControl')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__send_joint_control

            from node_interface.srv import _send_joint_control
            if _send_joint_control.Metaclass_SendJointControl_Request._TYPE_SUPPORT is None:
                _send_joint_control.Metaclass_SendJointControl_Request.__import_type_support__()
            if _send_joint_control.Metaclass_SendJointControl_Response._TYPE_SUPPORT is None:
                _send_joint_control.Metaclass_SendJointControl_Response.__import_type_support__()


class SendJointControl(metaclass=Metaclass_SendJointControl):
    from node_interface.srv._send_joint_control import SendJointControl_Request as Request
    from node_interface.srv._send_joint_control import SendJointControl_Response as Response
