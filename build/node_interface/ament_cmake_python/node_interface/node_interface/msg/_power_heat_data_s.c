...
bool node_interface__msg__power_heat_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("node_interface.msg._power_heat_data.PowerHeatData", full_classname_dest, 49) == 0);
  }
  node_interface__msg__PowerHeatData * ros_message = _ros_message;
  {  // chassis_volt
...
PyObject * node_interface__msg__power_heat_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("node_interface.msg._power_heat_data");
