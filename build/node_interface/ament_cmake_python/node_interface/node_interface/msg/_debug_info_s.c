...
bool node_interface__msg__debug_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("node_interface.msg._debug_info.DebugInfo", full_classname_dest, 40) == 0);
  }
  node_interface__msg__DebugInfo * ros_message = _ros_message;
  {  // debug_data
...
PyObject * node_interface__msg__debug_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("node_interface.msg._debug_info");
