...
bool node_interface__msg__board_alpha__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("node_interface.msg._board_alpha.BoardAlpha", full_classname_dest, 42) == 0);
  }
  node_interface__msg__BoardAlpha * ros_message = _ros_message;
  {  // data1
...
{
  /* NOTE(esteve): Call constructor of BoardAlpha */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("node_interface.msg._board_alpha");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BoardAlpha");
