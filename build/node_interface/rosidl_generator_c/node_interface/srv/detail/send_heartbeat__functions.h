...
#ifndef NODE_INTERFACE__SRV__DETAIL__SEND_HEARTBEAT__FUNCTIONS_H_
#define NODE_INTERFACE__SRV__DETAIL__SEND_HEARTBEAT__FUNCTIONS_H_
...
/// Initialize srv/SendHeartbeat message.
/**
...
/// Finalize srv/SendHeartbeat message.
/**
...
/// Create srv/SendHeartbeat message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * node_interface__srv__SendHeartbeat_Request__init().
...
/// Destroy srv/SendHeartbeat message.
/**
 * It calls
 * node_interface__srv__SendHeartbeat_Request__fini()
...
/// Check for srv/SendHeartbeat message equality.
/**
...
/// Copy a srv/SendHeartbeat message.
/**
...
/// Initialize array of srv/SendHeartbeat messages.
/**
...
/// Finalize array of srv/SendHeartbeat messages.
/**
 * It calls
 * node_interface__srv__SendHeartbeat_Request__fini()
...
/// Create array of srv/SendHeartbeat messages.
/**
 * It allocates the memory for the array and calls
 * node_interface__srv__SendHeartbeat_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SendHeartbeat messages.
/**
 * It calls
 * node_interface__srv__SendHeartbeat_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SendHeartbeat message array equality.
/**
...
/// Copy an array of srv/SendHeartbeat messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * node_interface__srv__SendHeartbeat_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_node_interface
...
/**
 * It calls
 * node_interface__srv__SendHeartbeat_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_node_interface
...
/**
 * It allocates the memory for the array and calls
 * node_interface__srv__SendHeartbeat_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_node_interface
...
/**
 * It calls
 * node_interface__srv__SendHeartbeat_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // NODE_INTERFACE__SRV__DETAIL__SEND_HEARTBEAT__FUNCTIONS_H_
