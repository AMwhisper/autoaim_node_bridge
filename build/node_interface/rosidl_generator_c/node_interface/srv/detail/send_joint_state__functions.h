...
#ifndef NODE_INTERFACE__SRV__DETAIL__SEND_JOINT_STATE__FUNCTIONS_H_
#define NODE_INTERFACE__SRV__DETAIL__SEND_JOINT_STATE__FUNCTIONS_H_
 ...
 * calls
 * node_interface__srv__SendJointState_Request__init().
...
/**
 * It calls
 * node_interface__srv__SendJointState_Request__fini()
 ...
 * node_interface__srv__SendJointState_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * node_interface__srv__SendJointState_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * node_interface__srv__SendJointState_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_node_interface
...
/**
 * It calls
 * node_interface__srv__SendJointState_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_node_interface
...
/**
 * It allocates the memory for the array and calls
 * node_interface__srv__SendJointState_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_node_interface
...
/**
 * It calls
 * node_interface__srv__SendJointState_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // NODE_INTERFACE__SRV__DETAIL__SEND_JOINT_STATE__FUNCTIONS_H_
