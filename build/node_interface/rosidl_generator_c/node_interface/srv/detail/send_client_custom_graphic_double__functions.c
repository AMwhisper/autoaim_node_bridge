...
node_interface__srv__SendClientCustomGraphicDouble_Request__init(node_interface__srv__SendClientCustomGraphicDouble_Request * msg)
{
  ...
  for (size_t i = 0; i < 2; ++i) {
    if (!node_interface__msg__GraphicDataType__init(&msg->grapic_data_struct[i])) {
      node_interface__srv__SendClientCustomGraphicDouble_Request__fini(msg);
      return false;
    }
  }
  return true;
...
node_interface__srv__SendClientCustomGraphicDouble_Request__create()
{
  ...
  node_interface__srv__SendClientCustomGraphicDouble_Request * msg = (node_interface__srv__SendClientCustomGraphicDouble_Request *)allocator.allocate(sizeof(node_interface__srv__SendClientCustomGraphicDouble_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(node_interface__srv__SendClientCustomGraphicDouble_Request));
  bool success = node_interface__srv__SendClientCustomGraphicDouble_Request__init(msg);
  if (!success) {
...
node_interface__srv__SendClientCustomGraphicDouble_Request__Sequence__init(node_interface__srv__SendClientCustomGraphicDouble_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  node_interface__srv__SendClientCustomGraphicDouble_Request * data = NULL;

  if (size) {
    data = (node_interface__srv__SendClientCustomGraphicDouble_Request *)allocator.zero_allocate(size, sizeof(node_interface__srv__SendClientCustomGraphicDouble_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = node_interface__srv__SendClientCustomGraphicDouble_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        node_interface__srv__SendClientCustomGraphicDouble_Request__fini(&data[i - 1]);
      }
...
node_interface__srv__SendClientCustomGraphicDouble_Request__Sequence__fini(node_interface__srv__SendClientCustomGraphicDouble_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      node_interface__srv__SendClientCustomGraphicDouble_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  node_interface__srv__SendClientCustomGraphicDouble_Request__Sequence * array = (node_interface__srv__SendClientCustomGraphicDouble_Request__Sequence *)allocator.allocate(sizeof(node_interface__srv__SendClientCustomGraphicDouble_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = node_interface__srv__SendClientCustomGraphicDouble_Request__Sequence__init(array, size);
  if (!success) {
...
node_interface__srv__SendClientCustomGraphicDouble_Request__Sequence__destroy(node_interface__srv__SendClientCustomGraphicDouble_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    node_interface__srv__SendClientCustomGraphicDouble_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
node_interface__srv__SendClientCustomGraphicDouble_Request__Sequence__are_equal(const node_interface__srv__SendClientCustomGraphicDouble_Request__Sequence * lhs, const node_interface__srv__SendClientCustomGraphicDouble_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!node_interface__srv__SendClientCustomGraphicDouble_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  node_interface__srv__SendClientCustomGraphicDouble_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(node_interface__srv__SendClientCustomGraphicDouble_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    node_interface__srv__SendClientCustomGraphicDouble_Request * data =
      (node_interface__srv__SendClientCustomGraphicDouble_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!node_interface__srv__SendClientCustomGraphicDouble_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          node_interface__srv__SendClientCustomGraphicDouble_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!node_interface__srv__SendClientCustomGraphicDouble_Request__copy(
...
node_interface__srv__SendClientCustomGraphicDouble_Response__init(node_interface__srv__SendClientCustomGraphicDouble_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->result)) {
    node_interface__srv__SendClientCustomGraphicDouble_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  node_interface__srv__SendClientCustomGraphicDouble_Response * msg = (node_interface__srv__SendClientCustomGraphicDouble_Response *)allocator.allocate(sizeof(node_interface__srv__SendClientCustomGraphicDouble_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(node_interface__srv__SendClientCustomGraphicDouble_Response));
  bool success = node_interface__srv__SendClientCustomGraphicDouble_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
node_interface__srv__SendClientCustomGraphicDouble_Response__Sequence__init(node_interface__srv__SendClientCustomGraphicDouble_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  node_interface__srv__SendClientCustomGraphicDouble_Response * data = NULL;

  if (size) {
    data = (node_interface__srv__SendClientCustomGraphicDouble_Response *)allocator.zero_allocate(size, sizeof(node_interface__srv__SendClientCustomGraphicDouble_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = node_interface__srv__SendClientCustomGraphicDouble_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        node_interface__srv__SendClientCustomGraphicDouble_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
node_interface__srv__SendClientCustomGraphicDouble_Response__Sequence__fini(node_interface__srv__SendClientCustomGraphicDouble_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      node_interface__srv__SendClientCustomGraphicDouble_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  node_interface__srv__SendClientCustomGraphicDouble_Response__Sequence * array = (node_interface__srv__SendClientCustomGraphicDouble_Response__Sequence *)allocator.allocate(sizeof(node_interface__srv__SendClientCustomGraphicDouble_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = node_interface__srv__SendClientCustomGraphicDouble_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
node_interface__srv__SendClientCustomGraphicDouble_Response__Sequence__destroy(node_interface__srv__SendClientCustomGraphicDouble_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    node_interface__srv__SendClientCustomGraphicDouble_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
node_interface__srv__SendClientCustomGraphicDouble_Response__Sequence__are_equal(const node_interface__srv__SendClientCustomGraphicDouble_Response__Sequence * lhs, const node_interface__srv__SendClientCustomGraphicDouble_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!node_interface__srv__SendClientCustomGraphicDouble_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  node_interface__srv__SendClientCustomGraphicDouble_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(node_interface__srv__SendClientCustomGraphicDouble_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    node_interface__srv__SendClientCustomGraphicDouble_Response * data =
      (node_interface__srv__SendClientCustomGraphicDouble_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!node_interface__srv__SendClientCustomGraphicDouble_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          node_interface__srv__SendClientCustomGraphicDouble_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!node_interface__srv__SendClientCustomGraphicDouble_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
