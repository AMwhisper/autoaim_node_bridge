...
node_interface__msg__AutoaimData__create()
{
  ...
  node_interface__msg__AutoaimData * msg = (node_interface__msg__AutoaimData *)allocator.allocate(sizeof(node_interface__msg__AutoaimData), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(node_interface__msg__AutoaimData));
  bool success = node_interface__msg__AutoaimData__init(msg);
  if (!success) {
...
node_interface__msg__AutoaimData__destroy(node_interface__msg__AutoaimData * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    node_interface__msg__AutoaimData__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
node_interface__msg__AutoaimData__Sequence__init(node_interface__msg__AutoaimData__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  node_interface__msg__AutoaimData * data = NULL;

  if (size) {
    data = (node_interface__msg__AutoaimData *)allocator.zero_allocate(size, sizeof(node_interface__msg__AutoaimData), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = node_interface__msg__AutoaimData__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        node_interface__msg__AutoaimData__fini(&data[i - 1]);
      }
...
node_interface__msg__AutoaimData__Sequence__fini(node_interface__msg__AutoaimData__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      node_interface__msg__AutoaimData__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  node_interface__msg__AutoaimData__Sequence * array = (node_interface__msg__AutoaimData__Sequence *)allocator.allocate(sizeof(node_interface__msg__AutoaimData__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = node_interface__msg__AutoaimData__Sequence__init(array, size);
  if (!success) {
...
node_interface__msg__AutoaimData__Sequence__destroy(node_interface__msg__AutoaimData__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    node_interface__msg__AutoaimData__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
node_interface__msg__AutoaimData__Sequence__are_equal(const node_interface__msg__AutoaimData__Sequence * lhs, const node_interface__msg__AutoaimData__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!node_interface__msg__AutoaimData__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  node_interface__msg__AutoaimData__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(node_interface__msg__AutoaimData);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    node_interface__msg__AutoaimData * data =
      (node_interface__msg__AutoaimData *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!node_interface__msg__AutoaimData__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          node_interface__msg__AutoaimData__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!node_interface__msg__AutoaimData__copy(
