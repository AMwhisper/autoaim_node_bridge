...
#include "node_interface/msg/detail/autoaim_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const node_interface::msg::AutoaimData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  node_interface::msg::AutoaimData & ros_message)
{
  // Member: yaw_angle_diff
  cdr >> ros_message.yaw_angle_diff;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = node_interface::msg::AutoaimData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const node_interface::msg::AutoaimData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<node_interface::msg::AutoaimData *>(
    untyped_ros_message);
...
{
  return &node_interface::msg::typesupport_fastrtps_cpp::_AutoaimData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, node_interface, msg, AutoaimData)() {
  return &node_interface::msg::typesupport_fastrtps_cpp::_AutoaimData__handle;
}
