...
#include "node_interface/msg/detail/heartbeat__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const node_interface::msg::Heartbeat & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  node_interface::msg::Heartbeat & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = node_interface::msg::Heartbeat;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const node_interface::msg::Heartbeat *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<node_interface::msg::Heartbeat *>(
    untyped_ros_message);
...
{
  return &node_interface::msg::typesupport_fastrtps_cpp::_Heartbeat__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, node_interface, msg, Heartbeat)() {
  return &node_interface::msg::typesupport_fastrtps_cpp::_Heartbeat__handle;
}
