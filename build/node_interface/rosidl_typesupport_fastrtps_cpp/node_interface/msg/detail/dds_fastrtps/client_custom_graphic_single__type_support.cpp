...
#include "node_interface/msg/detail/client_custom_graphic_single__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const node_interface::msg::ClientCustomGraphicSingle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  node_interface::msg::ClientCustomGraphicSingle & ros_message)
{
  // Member: data_cmd_id
  cdr >> ros_message.data_cmd_id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_node_interface
max_serialized_size_ClientCustomGraphicSingle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = node_interface::msg::ClientCustomGraphicSingle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const node_interface::msg::ClientCustomGraphicSingle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<node_interface::msg::ClientCustomGraphicSingle *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ClientCustomGraphicSingle__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const node_interface::msg::ClientCustomGraphicSingle *>(
...
static size_t _ClientCustomGraphicSingle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ClientCustomGraphicSingle(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ClientCustomGraphicSingle__callbacks = {
  "node_interface::msg",
...
static rosidl_message_type_support_t _ClientCustomGraphicSingle__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ClientCustomGraphicSingle__callbacks,
...
{
  return &node_interface::msg::typesupport_fastrtps_cpp::_ClientCustomGraphicSingle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, node_interface, msg, ClientCustomGraphicSingle)() {
  return &node_interface::msg::typesupport_fastrtps_cpp::_ClientCustomGraphicSingle__handle;
}
