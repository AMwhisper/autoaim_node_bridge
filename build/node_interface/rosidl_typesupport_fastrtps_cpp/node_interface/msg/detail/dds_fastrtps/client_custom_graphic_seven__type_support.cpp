...
#include "node_interface/msg/detail/client_custom_graphic_seven__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const node_interface::msg::ClientCustomGraphicSeven & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  node_interface::msg::ClientCustomGraphicSeven & ros_message)
{
  // Member: data_cmd_id
  cdr >> ros_message.data_cmd_id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_node_interface
max_serialized_size_ClientCustomGraphicSeven(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = node_interface::msg::ClientCustomGraphicSeven;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const node_interface::msg::ClientCustomGraphicSeven *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<node_interface::msg::ClientCustomGraphicSeven *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ClientCustomGraphicSeven__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const node_interface::msg::ClientCustomGraphicSeven *>(
...
static size_t _ClientCustomGraphicSeven__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ClientCustomGraphicSeven(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ClientCustomGraphicSeven__callbacks = {
  "node_interface::msg",
...
static rosidl_message_type_support_t _ClientCustomGraphicSeven__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ClientCustomGraphicSeven__callbacks,
...
{
  return &node_interface::msg::typesupport_fastrtps_cpp::_ClientCustomGraphicSeven__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, node_interface, msg, ClientCustomGraphicSeven)() {
  return &node_interface::msg::typesupport_fastrtps_cpp::_ClientCustomGraphicSeven__handle;
}
