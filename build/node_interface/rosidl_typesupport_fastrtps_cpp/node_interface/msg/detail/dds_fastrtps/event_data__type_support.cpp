...
#include "node_interface/msg/detail/event_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const node_interface::msg::EventData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  node_interface::msg::EventData & ros_message)
{
  // Member: event_type
  cdr >> ros_message.event_type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = node_interface::msg::EventData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const node_interface::msg::EventData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<node_interface::msg::EventData *>(
    untyped_ros_message);
...
{
  return &node_interface::msg::typesupport_fastrtps_cpp::_EventData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, node_interface, msg, EventData)() {
  return &node_interface::msg::typesupport_fastrtps_cpp::_EventData__handle;
}
