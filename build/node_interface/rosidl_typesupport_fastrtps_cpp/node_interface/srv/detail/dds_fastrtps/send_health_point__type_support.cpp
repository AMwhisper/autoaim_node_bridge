...
#include "node_interface/srv/detail/send_health_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const node_interface::srv::SendHealthPoint_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  node_interface::srv::SendHealthPoint_Request & ros_message)
{
  // Member: red_1_robot_hp
  cdr >> ros_message.red_1_robot_hp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_node_interface
max_serialized_size_SendHealthPoint_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = node_interface::srv::SendHealthPoint_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const node_interface::srv::SendHealthPoint_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<node_interface::srv::SendHealthPoint_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SendHealthPoint_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const node_interface::srv::SendHealthPoint_Request *>(
...
static size_t _SendHealthPoint_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SendHealthPoint_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SendHealthPoint_Request__callbacks = {
  "node_interface::srv",
...
static rosidl_message_type_support_t _SendHealthPoint_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SendHealthPoint_Request__callbacks,
...
{
  return &node_interface::srv::typesupport_fastrtps_cpp::_SendHealthPoint_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, node_interface, srv, SendHealthPoint_Request)() {
  return &node_interface::srv::typesupport_fastrtps_cpp::_SendHealthPoint_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_node_interface
cdr_serialize(
  const node_interface::srv::SendHealthPoint_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: result
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  node_interface::srv::SendHealthPoint_Response & ros_message)
{
  // Member: result
  cdr >> ros_message.result;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_node_interface
max_serialized_size_SendHealthPoint_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = node_interface::srv::SendHealthPoint_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const node_interface::srv::SendHealthPoint_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<node_interface::srv::SendHealthPoint_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SendHealthPoint_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const node_interface::srv::SendHealthPoint_Response *>(
...
static size_t _SendHealthPoint_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SendHealthPoint_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SendHealthPoint_Response__callbacks = {
  "node_interface::srv",
...
static rosidl_message_type_support_t _SendHealthPoint_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SendHealthPoint_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &node_interface::srv::typesupport_fastrtps_cpp::_SendHealthPoint_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, node_interface, srv, SendHealthPoint_Response)() {
  return &node_interface::srv::typesupport_fastrtps_cpp::_SendHealthPoint_Response__handle;
}
...
static service_type_support_callbacks_t _SendHealthPoint__callbacks = {
  "node_interface::srv",
  "SendHealthPoint",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, node_interface, srv, SendHealthPoint_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, node_interface, srv, SendHealthPoint_Response)(),
...
static rosidl_service_type_support_t _SendHealthPoint__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SendHealthPoint__callbacks,
...
{
  return &node_interface::srv::typesupport_fastrtps_cpp::_SendHealthPoint__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, node_interface, srv, SendHealthPoint)() {
  return &node_interface::srv::typesupport_fastrtps_cpp::_SendHealthPoint__handle;
}
