...
class Metaclass_SendPowerHeatData_Request(type):
    """Metaclass of message 'SendPowerHeatData_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__send_power_heat_data__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__send_power_heat_data__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__send_power_heat_data__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__send_power_heat_data__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__send_power_heat_data__request
...
class SendPowerHeatData_Request(metaclass=Metaclass_SendPowerHeatData_Request):
    """Message class 'SendPowerHeatData_Request'."""
...
class Metaclass_SendPowerHeatData_Response(type):
    """Metaclass of message 'SendPowerHeatData_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__send_power_heat_data__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__send_power_heat_data__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__send_power_heat_data__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__send_power_heat_data__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__send_power_heat_data__response
...
class SendPowerHeatData_Response(metaclass=Metaclass_SendPowerHeatData_Response):
    """Message class 'SendPowerHeatData_Response'."""
...
class Metaclass_SendPowerHeatData(type):
    """Metaclass of service 'SendPowerHeatData'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'node_interface.srv.SendPowerHeatData')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__send_power_heat_data

            from node_interface.srv import _send_power_heat_data
            if _send_power_heat_data.Metaclass_SendPowerHeatData_Request._TYPE_SUPPORT is None:
                _send_power_heat_data.Metaclass_SendPowerHeatData_Request.__import_type_support__()
            if _send_power_heat_data.Metaclass_SendPowerHeatData_Response._TYPE_SUPPORT is None:
                _send_power_heat_data.Metaclass_SendPowerHeatData_Response.__import_type_support__()


class SendPowerHeatData(metaclass=Metaclass_SendPowerHeatData):
    from node_interface.srv._send_power_heat_data import SendPowerHeatData_Request as Request
    from node_interface.srv._send_power_heat_data import SendPowerHeatData_Response as Response
