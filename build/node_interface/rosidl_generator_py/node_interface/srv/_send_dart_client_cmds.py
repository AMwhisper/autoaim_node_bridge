...
class Metaclass_SendDartClientCmds_Request(type):
    """Metaclass of message 'SendDartClientCmds_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'node_interface.srv.SendDartClientCmds_Request')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__send_dart_client_cmds__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__send_dart_client_cmds__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__send_dart_client_cmds__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__send_dart_client_cmds__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__send_dart_client_cmds__request
...
class SendDartClientCmds_Request(metaclass=Metaclass_SendDartClientCmds_Request):
    """Message class 'SendDartClientCmds_Request'."""
...
class Metaclass_SendDartClientCmds_Response(type):
    """Metaclass of message 'SendDartClientCmds_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'node_interface.srv.SendDartClientCmds_Response')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__send_dart_client_cmds__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__send_dart_client_cmds__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__send_dart_client_cmds__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__send_dart_client_cmds__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__send_dart_client_cmds__response
...
class SendDartClientCmds_Response(metaclass=Metaclass_SendDartClientCmds_Response):
    """Message class 'SendDartClientCmds_Response'."""
...
class Metaclass_SendDartClientCmds(type):
    """Metaclass of service 'SendDartClientCmds'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'node_interface.srv.SendDartClientCmds')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__send_dart_client_cmds

            from node_interface.srv import _send_dart_client_cmds
            if _send_dart_client_cmds.Metaclass_SendDartClientCmds_Request._TYPE_SUPPORT is None:
                _send_dart_client_cmds.Metaclass_SendDartClientCmds_Request.__import_type_support__()
            if _send_dart_client_cmds.Metaclass_SendDartClientCmds_Response._TYPE_SUPPORT is None:
                _send_dart_client_cmds.Metaclass_SendDartClientCmds_Response.__import_type_support__()


class SendDartClientCmds(metaclass=Metaclass_SendDartClientCmds):
    from node_interface.srv._send_dart_client_cmds import SendDartClientCmds_Request as Request
    from node_interface.srv._send_dart_client_cmds import SendDartClientCmds_Response as Response
