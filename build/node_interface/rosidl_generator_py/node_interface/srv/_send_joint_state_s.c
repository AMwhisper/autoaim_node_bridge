...
bool node_interface__srv__send_joint_state__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("node_interface.srv._send_joint_state.SendJointState_Request", full_classname_dest, 59) == 0);
  }
  node_interface__srv__SendJointState_Request * ros_message = _ros_message;
  {  // state_code
...
PyObject * node_interface__srv__send_joint_state__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("node_interface.srv._send_joint_state");
...
ROSIDL_GENERATOR_C_EXPORT
bool node_interface__srv__send_joint_state__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("node_interface.srv._send_joint_state.SendJointState_Response", full_classname_dest, 60) == 0);
  }
  node_interface__srv__SendJointState_Response * ros_message = _ros_message;
  {  // result
