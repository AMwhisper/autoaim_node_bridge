...
bool node_interface__srv__send_client_custom_graphic_seven__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("node_interface.srv._send_client_custom_graphic_seven.SendClientCustomGraphicSeven_Request", full_classname_dest, 89) == 0);
  }
  node_interface__srv__SendClientCustomGraphicSeven_Request * ros_message = _ros_message;
  {  // data_cmd_id
...
{
  /* NOTE(esteve): Call constructor of SendClientCustomGraphicSeven_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("node_interface.srv._send_client_custom_graphic_seven");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SendClientCustomGraphicSeven_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool node_interface__srv__send_client_custom_graphic_seven__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("node_interface.srv._send_client_custom_graphic_seven.SendClientCustomGraphicSeven_Response", full_classname_dest, 90) == 0);
  }
  node_interface__srv__SendClientCustomGraphicSeven_Response * ros_message = _ros_message;
  {  // result
...
{
  /* NOTE(esteve): Call constructor of SendClientCustomGraphicSeven_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("node_interface.srv._send_client_custom_graphic_seven");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SendClientCustomGraphicSeven_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
