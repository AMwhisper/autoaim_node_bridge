...
bool node_interface__srv__send_joint_control__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("node_interface.srv._send_joint_control.SendJointControl_Request", full_classname_dest, 63) == 0);
  }
  node_interface__srv__SendJointControl_Request * ros_message = _ros_message;
  {  // state_code
...
{
  /* NOTE(esteve): Call constructor of SendJointControl_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("node_interface.srv._send_joint_control");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SendJointControl_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool node_interface__srv__send_joint_control__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("node_interface.srv._send_joint_control.SendJointControl_Response", full_classname_dest, 64) == 0);
  }
  node_interface__srv__SendJointControl_Response * ros_message = _ros_message;
  {  // result
...
{
  /* NOTE(esteve): Call constructor of SendJointControl_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("node_interface.srv._send_joint_control");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SendJointControl_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
