...
bool node_interface__msg__client_custom_graphic_double__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("node_interface.msg._client_custom_graphic_double.ClientCustomGraphicDouble", full_classname_dest, 74) == 0);
  }
  node_interface__msg__ClientCustomGraphicDouble * ros_message = _ros_message;
  {  // data_cmd_id
...
{
  /* NOTE(esteve): Call constructor of ClientCustomGraphicDouble */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("node_interface.msg._client_custom_graphic_double");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ClientCustomGraphicDouble");
