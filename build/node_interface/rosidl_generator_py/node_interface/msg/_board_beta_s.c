...
bool node_interface__msg__board_beta__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("node_interface.msg._board_beta.BoardBeta", full_classname_dest, 40) == 0);
  }
  node_interface__msg__BoardBeta * ros_message = _ros_message;
  {  // data1
...
{
  /* NOTE(esteve): Call constructor of BoardBeta */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("node_interface.msg._board_beta");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BoardBeta");
