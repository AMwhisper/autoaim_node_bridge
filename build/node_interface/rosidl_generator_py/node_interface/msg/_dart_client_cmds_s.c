...
bool node_interface__msg__dart_client_cmds__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("node_interface.msg._dart_client_cmds.DartClientCmds", full_classname_dest, 51) == 0);
  }
  node_interface__msg__DartClientCmds * ros_message = _ros_message;
...
{
  /* NOTE(esteve): Call constructor of DartClientCmds */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("node_interface.msg._dart_client_cmds");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DartClientCmds");
