...
static const _SendDartRemainingTime_Request_type_support_symbol_names_t _SendDartRemainingTime_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_interface, srv, SendDartRemainingTime_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, node_interface, srv, SendDartRemainingTime_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, node_interface, srv, SendDartRemainingTime_Request)() {
  return &::node_interface::srv::rosidl_typesupport_c::SendDartRemainingTime_Request_message_type_support_handle;
}
...
static const _SendDartRemainingTime_Response_type_support_symbol_names_t _SendDartRemainingTime_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_interface, srv, SendDartRemainingTime_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, node_interface, srv, SendDartRemainingTime_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, node_interface, srv, SendDartRemainingTime_Response)() {
  return &::node_interface::srv::rosidl_typesupport_c::SendDartRemainingTime_Response_message_type_support_handle;
}
...
static const _SendDartRemainingTime_type_support_symbol_names_t _SendDartRemainingTime_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_interface, srv, SendDartRemainingTime)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, node_interface, srv, SendDartRemainingTime)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, node_interface, srv, SendDartRemainingTime)() {
  return &::node_interface::srv::rosidl_typesupport_c::SendDartRemainingTime_service_type_support_handle;
}
