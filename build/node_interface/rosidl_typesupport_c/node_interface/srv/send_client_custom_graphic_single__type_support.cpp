...
static const _SendClientCustomGraphicSingle_Request_type_support_symbol_names_t _SendClientCustomGraphicSingle_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_interface, srv, SendClientCustomGraphicSingle_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, node_interface, srv, SendClientCustomGraphicSingle_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, node_interface, srv, SendClientCustomGraphicSingle_Request)() {
  return &::node_interface::srv::rosidl_typesupport_c::SendClientCustomGraphicSingle_Request_message_type_support_handle;
}
...
static const _SendClientCustomGraphicSingle_Response_type_support_symbol_names_t _SendClientCustomGraphicSingle_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_interface, srv, SendClientCustomGraphicSingle_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, node_interface, srv, SendClientCustomGraphicSingle_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, node_interface, srv, SendClientCustomGraphicSingle_Response)() {
  return &::node_interface::srv::rosidl_typesupport_c::SendClientCustomGraphicSingle_Response_message_type_support_handle;
}
...
static const _SendClientCustomGraphicSingle_type_support_symbol_names_t _SendClientCustomGraphicSingle_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, node_interface, srv, SendClientCustomGraphicSingle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, node_interface, srv, SendClientCustomGraphicSingle)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, node_interface, srv, SendClientCustomGraphicSingle)() {
  return &::node_interface::srv::rosidl_typesupport_c::SendClientCustomGraphicSingle_service_type_support_handle;
}
