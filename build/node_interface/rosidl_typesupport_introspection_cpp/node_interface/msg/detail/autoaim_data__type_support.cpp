...
{
  new (message_memory) node_interface::msg::AutoaimData(_init);
}

void AutoaimData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<node_interface::msg::AutoaimData *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AutoaimData_message_member_array[3] = {
  {
    ...
    offsetof(node_interface::msg::AutoaimData, yaw_angle_diff),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(node_interface::msg::AutoaimData, pitch_angle_diff),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(node_interface::msg::AutoaimData, fire),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AutoaimData_message_members = {
  ...
  3,  // number of fields
  sizeof(node_interface::msg::AutoaimData),
...
get_message_type_support_handle<node_interface::msg::AutoaimData>()
{
  return &::node_interface::msg::rosidl_typesupport_introspection_cpp::AutoaimData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, node_interface, msg, AutoaimData)() {
  return &::node_interface::msg::rosidl_typesupport_introspection_cpp::AutoaimData_message_type_support_handle;
}
